...
private:
    ...
    /**
     * This is the memory information that will be displayed in the KCM.
     *
     * Default value is set in case the memory information is not available.
     */
    QString m_memoryInformation = ki18nc( //
                                      "Default text for the KCM, in case memory information couldn't be retrieved",
