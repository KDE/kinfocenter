...
void WaylandModule::init()
{
    ...
    connect(
        ...
        [this, compositorItem, interfacesItem] {
            ...
            connect(registry, &Registry::interfaceAnnounced, this, [this, interfacesItem](const QByteArray &interface, quint32 name, quint32 version) {
                Q_UNUSED(name)
                new QTreeWidgetItem(interfacesItem, QStringList() << QString::fromLatin1(interface) << QString::number(version));
            });
            connect(registry, &Registry::seatAnnounced, this, [this, registry, compositorItem](quint32 name, quint32 version) {
                ...
                connect(seat, &Seat::nameChanged, this, [this, seat, seatItem] {
                    new QTreeWidgetItem(seatItem, QStringList() << i18n("Name") << seat->name());
                });
                connect(seat, &Seat::hasPointerChanged, this, [this, seat, seatItem] {
                    if (seat->hasPointer()) {
                        new QTreeWidgetItem(seatItem, QStringList() << i18n("Pointer"));
                    }
                });
                connect(seat, &Seat::hasKeyboardChanged, this, [this, seat, seatItem] {
                    if (seat->hasKeyboard()) {
                        ...
                        connect(k, &Keyboard::keyRepeatChanged, this, [this, k, e, r, d] {
                ...
                connect(seat, &Seat::hasTouchChanged, this, [this, seat, seatItem] {
                    if (seat->hasTouch()) {
            ...
            connect(registry, &Registry::outputAnnounced, this, [this, registry, outputItem](quint32 name, quint32 version) {
                Output *output = registry->createOutput(name, version, registry);
                connect(output, &Output::changed, this, [this, output, outputItem] {
                    output->deleteLater();
                    ...
                    for (const auto &mode : output->modes()) {
                        ...
                        new QTreeWidgetItem(modeItem, QStringList() << i18n("Size") << QStringLiteral("%1x%2").arg(mode.size.width()).arg(mode.size.height()));
                        new QTreeWidgetItem(modeItem, QStringList() << i18n("Refresh Rate") << QString::number(mode.refreshRate));
                        new QTreeWidgetItem(modeItem,
                                            QStringList()
                                                << i18n("Preferred") << (mode.flags.testFlag(Output::Mode::Flag::Preferred) ? i18n("yes") : i18n("no")));
                        new QTreeWidgetItem(modeItem,
                                            QStringList() << i18n("Current") << (mode.flags.testFlag(Output::Mode::Flag::Current) ? i18n("yes") : i18n("no")));
                    }
                });
            });
            m_registry = registry;
